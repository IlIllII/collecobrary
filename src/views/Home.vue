<template>
  <div>
      <div class="subject-select" v-if="subjectSelect">
        <h1>What would you like to learn?</h1>
            <div class="subject-container">
                <div class="subject-listing" v-for="subject in subjects" :key="subject" @click="createMap(subject.id)">
      ...
      <div class="degree-map" v-if="!subjectSelect">
        ...
        <DegreeMap :propNodes="nodes" :propLinks="links" :descriptions="descriptions" :subject="selectedSubject" />
