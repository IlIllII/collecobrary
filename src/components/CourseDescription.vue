  ...
  <div>
    <div class="description" v-if="course != ''">
      ...
      <p>
        Provided by:
        <span
          v-for="equivalent of descriptions[course].courses"
          v-bind:key="equivalent.index"
        >
          <span> | </span>
          <a
            :class="{ active: idx == equivalent.index }"
            style="cursor: pointer"
            @click="idx = equivalent.index"
            >{{ equivalent.institution }}</a
          >
        </span>
        <span> | </span>
      </p>
      ...
      <p>
        <a target="_blank" :href="descriptions[course].courses[idx].url"
          >Go to course -&gt;</a
        >
      </p>
